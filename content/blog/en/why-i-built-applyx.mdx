...
To read your inbox and understand it, a normal SaaS would do two things: ask for OAuth access to your Gmail, and send the email text to a cloud AI to classify it. Think about what that means for _this_ data specifically. Your job search is some of the most sensitive information you have — which companies you're talking to, who rejected you, what salary was discussed, the fact that you're looking at all while still employed.
