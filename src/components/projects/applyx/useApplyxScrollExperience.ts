      ...
      const ctx = gsap.context(() => {
        ...
        mm.add(
          ...
          context => {
            ...
            // --- INGEST (pinned, scrubbed): email → classify → pipeline ---
            ...
            if (ingestPin) {
              ...
              tl.to('[data-scanline]', { yPercent: 640, opacity: 1, duration: 0.6 }, 0)
                .to('[data-scanline]', { opacity: 0, duration: 0.15 }, 0.6)
                .to('[data-status="reading"]', { opacity: 0, duration: 0.2 }, 0.35)
                .to('[data-status="classifying"]', { opacity: 1, duration: 0.2 }, 0.4)
                .from(
                  '[data-extract]',
                  { opacity: 0, y: 14, xPercent: -6, stagger: 0.18, duration: 0.5 },
                  0.55
                )
                .to('[data-status="classifying"]', { opacity: 0, duration: 0.2 }, 1.1)
                .to('[data-status="classified"]', { opacity: 1, duration: 0.2 }, 1.15)
                .from('[data-connector]', { drawSVG: '0%', duration: 0.6 }, 1.0)
                .to(
                  '[data-packet]',
                  {
                    motionPath: {
                      path: '[data-connector]',
                      align: '[data-connector]',
                      alignOrigin: [0.5, 0.5],
                    },
                    opacity: 1,
                    duration: 0.6,
                ...
                .to('[data-packet]', { opacity: 0, scale: 0, duration: 0.15 }, 1.7)
                .from(
                  '[data-appcard]',
                  { opacity: 0, scale: 0.85, y: 20, duration: 0.5, ease: 'back.out(1.6)' },
                  1.7
                );
            }
