...
export function HeroSection() {
  ...
  return (
    ...
    >
      {/* Spotlight Effect */}
      {!prefersReducedMotion && !isMobile && <div style={spotlightStyle} />}
      ...
      <div className="absolute inset-0 opacity-40">
        <DynamicScene3D>
          <Blob3D position={[2, 0, -2]} scale={isMobile ? 1.5 : 2} color="#3b82f6" />
          <Blob3D position={[-2, 1, -3]} scale={isMobile ? 1 : 1.5} color="#8b5cf6" />
          <Blob3D position={[0, -2, -4]} scale={isMobile ? 0.8 : 1.2} color="#10b981" />
        </DynamicScene3D>
      </div>
