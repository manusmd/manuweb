...
import { Mail, Github, Linkedin, MapPin, Send, MessageCircle, ArrowRight } from 'lucide-react';
                ...
                <div className="relative">
                  <div className="flex flex-col sm:flex-row items-center gap-6 p-6 md:p-8 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                    ...
                    <div className="text-center sm:text-left">
                      <h3 className="text-2xl md:text-3xl font-display font-bold mb-2">Manuel Schmid</h3>
              ...
              <div className="space-y-6">
                <div className="grid gap-4">
                  {contactMethods.map((method, index) => {
                    ...
                    const content = (
                      <div className={`group p-6 rounded-xl border bg-card/80 backdrop-blur-sm hover:border-primary/30 transition-all duration-500 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 ${method.bgColor} ${method.hoverColor}`}>
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-full ${method.bgColor} group-hover:scale-110 transition-transform ${method.color}`}>
