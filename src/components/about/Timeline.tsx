...
import { Mail, Github, Linkedin, ChevronRight, Code, Briefcase, GraduationCap } from 'lucide-react';
...
const companyThemes: Record<string, {
  ...
  'T-Systems': {
    ...
    icon: '',
    pattern: 'opacity-20 bg-[radial-gradient(circle_at_30%_70%,rgba(255,0,255,0.2),transparent_50%)]',
    visualElement: 'tech',
  ...
  'PRGH': {
    ...
    icon: '',
    pattern: 'opacity-20 bg-[radial-gradient(circle_at_70%_30%,rgba(147,51,234,0.3),transparent_50%)]',
  ...
  'Neue Fische': {
    ...
    icon: '',
    pattern: 'opacity-20 bg-[radial-gradient(circle_at_20%_80%,rgba(255,165,0,0.4),transparent_50%)]',
...
export function Timeline() {
  ...
  useEffect(() => {
    ...
    if (!isClient || isMobile || !gsap || !ScrollTrigger || !containerRef.current || !horizontalRef.current) {
      return;
    }
    ...
    const scrollTrigger = ScrollTrigger.create({
      ...
      onUpdate: (self: any) => {
        ...
        // Force panels to maintain proper scale and opacity
        Array.from(panels).forEach((panel) => {
          gsap.set(panel, { 
            scale: 1,
            opacity: 1,
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto px-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-16">
              ...
              <Button 
                ...
                asChild
              >
                <a href="https://www.linkedin.com/in/manusmd/" target="_blank" rel="noopener noreferrer">
              ...
              <div className="max-w-4xl w-full relative z-10 px-8">
                <div className="text-center space-y-8">
                  <div className="space-y-6">
                    <span className={`text-sm font-medium px-4 py-2 rounded-full inline-block ${theme.cardBg} ${theme.textColor} ${theme.borderColor}`}>
                      {exp.date}
                    </span>
                    <h3 className={`text-5xl lg:text-7xl font-display font-bold leading-tight ${theme.textColor}`}>
                      {exp.title}
                    </h3>
                  ...
                  {!isSecret && (
                    <div className="mt-12">
                      <p className={`text-xl ${theme.textColor} leading-relaxed max-w-3xl mx-auto opacity-90`}>
                        {exp.description}
                      </p>
                    </div>
                  )}
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 px-6 py-20 text-center max-w-lg mx-auto">
                  <div className="space-y-6">
                    <span className={`text-xs font-medium px-3 py-1 rounded-full inline-block ${theme.cardBg} ${theme.textColor} ${theme.borderColor}`}>
                      {exp.date}
                    </span>
                    <h3 className={`text-3xl sm:text-4xl font-bold leading-tight ${theme.textColor}`}>
                      {exp.title}
                    </h3>
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative h-px w-6">
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-700 ${
                  ...
                  {experiences.map((exp, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      ...
                      {index < experiences.length - 1 && (
                        <div className="relative h-px w-6">
                          <div className="absolute inset-0 bg-gradient-to-r from-gray-600 to-gray-500"></div>
                          <div className={`absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-700 delay-${(index + 1) * 100} ${
                            currentPanel > index + 1 ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
                          }`}></div>
                        </div>
                      )}
                    </div>
